...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (langToggle) {
    ...
    newBtn.addEventListener('click', () => {
      toggleLang();
      // Re-renderizar contenido dinámico con el nuevo idioma
      if (typeof renderFleet === 'function' && window.allShips && window.allShips.length) {
        renderFleet(window.allShips);
        if (typeof populateShipSelect === 'function') {
